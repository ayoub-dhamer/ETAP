...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3447862109ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=etap&table=bon_commande">`etap`.`bon_commande`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=etap&table=facture">`etap`.`facture`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=etap&table=fiche">`etap`.`fiche`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=etap&table=bordreau">`etap`.`bordreau`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=etap&table=user">`etap`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=etap&table=sign">`etap`.`sign`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=etap&table=bon_commande_items">`etap`.`bon_commande_items`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=etap&table=lab">`etap`.`lab`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=etap&table=client">`etap`.`client`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=etap&table=price">`etap`.`price`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4f353861235d70576b63365366245277">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="etap" targettable="bon_commande">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `bon_commande`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="etap" targettable="bon_commande">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `bon_commande`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="etap" targettable="bordreau">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `bordreau`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="etap" targettable="fiche">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `fiche`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="etap" targettable="facture">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `facture`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="etap" targettable="bon_commande">
                            <div class="action_content">
